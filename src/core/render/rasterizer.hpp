...
public:
    Framebuffer(int width, int height)
        : width_(width), height_(height), color_(static_cast<std::size_t>(width) * height * 4, 0),
    ...
    void draw_triangle(const ScreenVertex& a, const ScreenVertex& b, const ScreenVertex& c,
                       bool cull_backfaces);
    ...
    void draw_triangle_textured(const ScreenVertex& a, const ScreenVertex& b, const ScreenVertex& c,
...
void clip_near(const ViewVertex in[3], float near_z, std::vector<ViewVertex>& out_tris);
