...
| `+0x24` | 36 | bytes | contained item | observed | item id is the leading u32 |
| `+0x48` | 16 | bytes | projectile/spell state | inferred | executable accesses; meanings incomplete |
...
- The full contained-item and projectile-state field layouts.
